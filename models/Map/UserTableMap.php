...
class UserTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('UserId', 'Email', 'Password', 'Role', ),
        self::TYPE_CAMELNAME     => array('userId', 'email', 'password', 'role', ),
        self::TYPE_COLNAME       => array(UserTableMap::COL_USER_ID, UserTableMap::COL_EMAIL, UserTableMap::COL_PASSWORD, UserTableMap::COL_ROLE, ),
        self::TYPE_FIELDNAME     => array('user_id', 'email', 'password', 'role', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('UserId' => 0, 'Email' => 1, 'Password' => 2, 'Role' => 3, ),
        self::TYPE_CAMELNAME     => array('userId' => 0, 'email' => 1, 'password' => 2, 'role' => 3, ),
        self::TYPE_COLNAME       => array(UserTableMap::COL_USER_ID => 0, UserTableMap::COL_EMAIL => 1, UserTableMap::COL_PASSWORD => 2, UserTableMap::COL_ROLE => 3, ),
        self::TYPE_FIELDNAME     => array('user_id' => 0, 'email' => 1, 'password' => 2, 'role' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
